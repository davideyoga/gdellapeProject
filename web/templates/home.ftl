...
<head>
    ...
    <title>Edifying an Educational School Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
    <!-- custom-theme -->
	...
	Smartphone Compatible web template, free for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="web/templates/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- js -->
